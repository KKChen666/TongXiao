"""
V2: Insert seed data — subjects, books, topics, and cards for 考研英语 and 考研政治.
Skips if subjects already exist (idempotent).
"""
version = "2"
...
def migrate(conn, cur, db_type, placeholder):
    ...
    cur.execute(
        f"INSERT INTO subjects (name, display_name, icon) VALUES ({placeholder}, {placeholder}, {placeholder})",
        ("english", "考研英语", "📖"),
    )
    cur.execute(
        f"INSERT INTO subjects (name, display_name, icon) VALUES ({placeholder}, {placeholder}, {placeholder})",
    ...
    # Books
    cur.execute(
        f"INSERT INTO books (subject_id, name, order_num) VALUES ({placeholder},{placeholder},{placeholder})",
        (eng_id, "红宝书·考研英语词汇", 1),
    )
    cur.execute(
        f"INSERT INTO books (subject_id, name, order_num) VALUES ({placeholder},{placeholder},{placeholder})",
    ...
    for name, order in english_topics:
        cur.execute(
            f"INSERT INTO topics (subject_id, book_id, name, order_num) VALUES ({placeholder},{placeholder},{placeholder},{placeholder})",
    ...
    english_cards = {
        ...
        2: [
            ("capacity", "n. 能力；容量"), ("capture", "v. 捕获；引起"), ("category", "n. 类别；种类"),
            ("cause", "n. 原因\nv. 引起"), ("challenge", "n. 挑战\nv. 向……挑战"),
            ("characteristic", "n. 特征\nadj. 典型的"), ("circumstance", "n. 环境；情况"),
            ("claim", "v. 声称；要求\nn. 主张"), ("clarify", "v. 澄清；阐明"),
            ("classify", "v. 分类；归类"), ("climate", "n. 气候；风气"),
            ("collapse", "v. 倒塌；崩溃"), ("command", "v. 命令；指挥"),
            ("comment", "n. 评论\nv. 评论"), ("commit", "v. 犯罪；承诺"),
            ("communicate", "v. 交流；传达"), ("community", "n. 社区；团体"),
            ("companion", "n. 同伴；伙伴"), ("compare", "v. 比较；对比"),
            ("compel", "v. 强迫；迫使"), ("compensate", "v. 补偿；赔偿"),
            ("competent", "adj. 有能力的"), ("competitive", "adj. 竞争的"),
            ("complaint", "n. 投诉；抱怨"), ("complex", "adj. 复杂的"),
            ("component", "n. 组成部分"), ("compose", "v. 组成；创作"),
            ("comprehension", "n. 理解力"), ("comprehensive", "adj. 全面的；综合的"),
            ("concentrate", "v. 集中；专注"), ("concept", "n. 概念；观念"),
            ("concern", "n. 关心\nv. 涉及"), ("conclude", "v. 结束；推断"),
            ("concrete", "adj. 具体的；有形的"), ("conduct", "v. 引导；实施\nn. 行为"),
            ("conference", "n. 会议；讨论会"), ("confident", "adj. 自信的"),
            ("confirm", "v. 确认；证实"), ("conflict", "n. 冲突；矛盾"),
            ("conscious", "adj. 有意识的"), ("consequence", "n. 结果；后果"),
            ("conservative", "adj. 保守的"), ("considerable", "adj. 相当大的"),
            ("consist", "v. 由……组成"), ("consistent", "adj. 一致的"),
            ("constant", "adj. 不断的"), ("constitute", "v. 构成；组成"),
            ("construct", "v. 建造；构造"), ("consult", "v. 咨询；查阅"),
            ("consume", "v. 消费；消耗"),
        ],
        3: [
            ("contemporary", "adj. 当代的"), ("contradiction", "n. 矛盾；反驳"),
            ("contribute", "v. 贡献；导致"), ("controversy", "n. 争论；争议"),
            ("convention", "n. 惯例；大会"), ("convince", "v. 使确信；说服"),
            ("cooperate", "v. 合作；协作"), ("correspond", "v. 对应；通信"),
            ("crisis", "n. 危机"), ("criteria", "n. 标准（复数）"),
            ("crucial", "adj. 关键的"), ("cultivate", "v. 培养；陶冶"),
            ("curriculum", "n. 课程"), ("debate", "n. 辩论\nv. 辩论"),
            ("decade", "n. 十年"), ("decline", "v. 下降；拒绝\nn. 下降"),
            ("decorate", "v. 装饰"), ("decrease", "v. 减少\nn. 减少"),
            ("defeat", "v. 击败\nn. 失败"), ("defend", "v. 防御；辩护"),
            ("define", "v. 定义；界定"), ("definite", "adj. 明确的"),
            ("deliberate", "adj. 故意的；深思熟虑的"), ("delicate", "adj. 精致的；微妙的"),
            ("deliver", "v. 交付；发表"), ("demonstrate", "v. 证明；示范"),
            ("depict", "v. 描绘；描述"), ("deposit", "v. 存放；储蓄\nn. 存款"),
            ("deprive", "v. 剥夺"), ("derive", "v. 源于；获得"),
            ("deserve", "v. 应得；值得"), ("designate", "v. 指定；指派"),
            ("desperate", "adj. 绝望的；拼命的"), ("despite", "prep. 尽管"),
            ("destination", "n. 目的地"), ("destruction", "n. 破坏；毁灭"),
            ("determine", "v. 决定；确定"), ("develop", "v. 发展；开发"),
            ("device", "n. 设备；装置"), ("devote", "v. 致力于；奉献"),
            ("differentiate", "v. 区分；区别"), ("dimension", "n. 维度；方面"),
            ("discipline", "n. 学科；纪律"), ("discount", "n. 折扣\nv. 打折"),
            ("discriminate", "v. 歧视；辨别"), ("displace", "v. 取代；转移"),
            ("display", "v. 展示\nn. 展览"), ("distinct", "adj. 明显的；独特的"),
            ("distinguish", "v. 区分；辨别"), ("distribute", "v. 分配；分发"),
            ("diverse", "adj. 多样的"), ("domestic", "adj. 国内的"),
            ("dominate", "v. 主导；支配"), ("dramatic", "adj. 戏剧性的"),
            ("duration", "n. 持续时间"), ("dynamic", "adj. 动态的\nn. 动力"),
        ],
        4: [
        ...
        5: [
            ("account for", "解释；占……比例"), ("ascribe to", "归因于"),
            ("attribute to", "归因于"), ("break down", "分解；出故障"),
            ("bring about", "引起；导致"), ("by contrast", "相比之下"),
            ("carry out", "执行；实施"), ("come up with", "提出；想出"),
            ("consist of", "由……组成"), ("contribute to", "有助于；导致"),
            ("depend on", "依赖；取决于"), ("draw on", "利用；凭借"),
            ("engage in", "从事；参与"), ("figure out", "弄明白；计算出"),
            ("give rise to", "引起；导致"), ("in terms of", "就……而言"),
            ("lay off", "解雇；停止"), ("make sense", "有意义；讲得通"),
            ("point of view", "观点；看法"), ("put forward", "提出；推荐"),
            ("refer to", "参考；指的是"), ("result in", "导致；造成"),
            ("set about", "开始；着手"), ("take over", "接管；接收"),
            ("turn out", "结果是；生产"), ("work out", "解决；制定出"),
        ],
        6: [
            ("on the whole", "总的来说"), ("in general", "一般来说"),
            ("for instance", "例如"), ("such as", "比如"),
            ("as a result", "因此"), ("in addition", "此外"),
            ("furthermore", "而且；此外"), ("nevertheless", "然而；不过"),
            ("nonetheless", "尽管如此"), ("otherwise", "否则；不然"),
            ("provided that", "假如；如果"), ("regardless of", "不管；不顾"),
            ("in spite of", "尽管"), ("due to", "由于"),
            ("owing to", "因为；由于"), ("thanks to", "幸亏；由于"),
            ("with respect to", "关于；至于"), ("on behalf of", "代表"),
            ("in favor of", "支持；赞成"), ("in light of", "鉴于；根据"),
        ],
    }
    ...
    hongbao_topic_ids = {1: 7, 2: 8, 3: 9, 4: 10, 5: 11, 6: 12, 7: 13}

    for idx, card in enumerate(hongbao_cards):
        front, phonetic, back, example, back_detail = card
        cur.execute(
            f"INSERT INTO cards (topic_id, front, back, phonetic, example, back_detail, order_num) VALUES ({placeholder},{placeholder},{placeholder},{placeholder},{placeholder},{placeholder},{placeholder})",
